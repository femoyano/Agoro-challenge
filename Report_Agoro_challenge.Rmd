...
While Gruijter et al. 2016 aim to maximize an expected profit taking into account sequestered C price, sampling costs and a trading parameter (that balances farmer's and buyer's risks due to uncertainty in C sequestered), the objective here is simpler: we only need to find the minimum number of samples that will give a confidence interval (CI) of less than 15% of the mean.
...
### The following section deals with the optimization procedure
